...
s += "                                <\/div>";
s += "                                <div class=\"item\" onclick=\"viewer.share(); addRemoveClass('class','menu','active'); return false;\">";
