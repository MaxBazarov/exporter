...
function buildMainHTML(docName, centerContent,commentsURL,hideNav,googleCode) {
  ...
  s += '<script type="text/javascript" src="resources/page.js" charset="UTF-8"></script>\n';
  ...
  s += ' <div id="container">\n';
  s += ' <div id="content">\n';
  s += ' <div id="fixed_top" class="hidden"></div><div id="fixed_top_back" class="hidden"></div>\n';
  s += ' <div id="fixed_left" class="hidden"></div><div id="fixed_left_back" class="hidden"></div>\n';  
  s += ' </div>\n'; 
